...
public:
    ...
    {
        lite3dpp::Scene *scene = main->getResourceManager()->queryResource<lite3dpp::Scene>("SceneInTexture",
            "samples:scenes/scene_rtt.json");
        mMinigun = scene->getObject("Minigun");
        mPlasmagun = scene->getObject("Plasmagun");

        scene = main->getResourceManager()->queryResource<lite3dpp::Scene>("BoxScene",

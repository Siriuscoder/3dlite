...
public:
	...
	lite3dpp::String  GetSectionName(unsigned int idx) const;
...
protected:
	...
	lite3dpp::String modifiedScript;

	INCLUDECALLBACK_t  includeCallback;
	void              *callbackParam;

#if AS_PROCESS_METADATA == 1
	int  ExtractMetadataString(int pos, lite3dpp::String &outMetadata);
	int  ExtractDeclaration(int pos, lite3dpp::String &outDeclaration, int &outType);

	// Temporary structure for storing metadata and declaration
	struct SMetadataDecl
	{
		SMetadataDecl(lite3dpp::String m, lite3dpp::String d, int t, lite3dpp::String c, lite3dpp::String ns) : metadata(m), declaration(d), type(t), parentClass(c), nameSpace(ns) {}
		lite3dpp::String  metadata;
		lite3dpp::String  declaration;
		int                         type;
		lite3dpp::String  parentClass;
		lite3dpp::String  nameSpace;
	};
	lite3dpp::stl<SMetadataDecl>::vector foundDeclarations;
	lite3dpp::String currentClass;
	lite3dpp::String currentNamespace;

	// Storage of metadata for global declarations
	lite3dpp::stl<int, lite3dpp::String>::map typeMetadataMap;
	lite3dpp::stl<int, lite3dpp::String>::map funcMetadataMap;
	lite3dpp::stl<int, lite3dpp::String>::map varMetadataMap;

	// Storage of metadata for class member declarations
	struct SClassMetadata
	{
		SClassMetadata(const lite3dpp::String& aName) : className(aName) {}
		lite3dpp::String className;
		lite3dpp::stl<int, lite3dpp::String>::map funcMetadataMap;
		lite3dpp::stl<int, lite3dpp::String>::map varMetadataMap;
	};
	...
	lite3dpp::stl<lite3dpp::String>::set      includedScripts;
	lite3dpp::stl<lite3dpp::String>::set      definedWords;
};

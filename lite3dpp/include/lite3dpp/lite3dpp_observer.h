...
#define LITE3D_OBSERVER_NOTIFY(func) { for(auto o : getObservers()) o->func(); }
#define LITE3D_OBSERVER_NOTIFY_1(func, p1) { for(auto o : getObservers()) o->func(p1); }
#define LITE3D_OBSERVER_NOTIFY_2(func, p1, p2) { for(auto o : getObservers()) o->func(p1, p2); }
#define LITE3D_OBSERVER_NOTIFY_3(func, p1, p2, p3) { for(auto o : getObservers()) o->func(p1, p2, p3); }
#define LITE3D_OBSERVER_NOTIFY_4(func, p1, p2, p3, p4) { for(auto o : getObservers()) o->func(p1, p2, p3, p4); }
#define LITE3D_OBSERVER_NOTIFY_5(func, p1, p2, p3, p4, p5) { for(auto o : getObservers()) o->func(p1, p2, p3, p4, p5); }
#define LITE3D_OBSERVER_NOTIFY_6(func, p1, p2, p3, p4, p5, p6) { for(auto o : getObservers()) o->func(p1, p2, p3, p4, p5, p6); }

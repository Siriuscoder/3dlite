...
static const lite3dpp::String emptyString;

static const lite3dpp::String &StringFactory(asUINT length, const char *s)
{
	...
	map<const char *, lite3dpp::String> *pool = reinterpret_cast< map<const char *, lite3dpp::String>* >(engine->GetUserData(STRING_POOL));
	...
	if( !pool )
	{
		...
		pool = reinterpret_cast< map<const char *, lite3dpp::String>* >(engine->GetUserData(STRING_POOL));
		if( !pool )
		{
			#if defined(__S3E__)
			pool = new map<const char *, lite3dpp::String>;
			#else
			pool = new (nothrow) map<const char *, lite3dpp::String>;
			#endif
			if( pool == 0 )
			{
	...
	map<const char *, lite3dpp::String>::iterator it;
	it = pool->find(s);
	if( it != pool->end() )
	{
		asReleaseSharedLock();
	...
	if( it == pool->end() )
	{
		...
		it = pool->insert(map<const char *, lite3dpp::String>::value_type(s, lite3dpp::String(s, length))).first;
	}
...
#else
static lite3dpp::String StringFactory(asUINT length, const char *s)
{
	return lite3dpp::String(s, length);
}
#endif

static void ConstructString(lite3dpp::String *thisPointer)
{
	new(thisPointer) lite3dpp::String();
}

static void CopyConstructString(const lite3dpp::String &other, lite3dpp::String *thisPointer)
{
	new(thisPointer) lite3dpp::String(other);
}

static void DestructString(lite3dpp::String *thisPointer)
{
    using lite3dpp::String;
	thisPointer->~String();
}

static lite3dpp::String &AddAssignStringToString(const lite3dpp::String &str, lite3dpp::String &dest)
{
...
static bool StringIsEmpty(const lite3dpp::String &str)
{
	// We don't register the method directly because some compilers
	// and standard libraries inline the definition, resulting in the
	// linker being unable to find the declaration
...
static lite3dpp::String &AssignUInt64ToString(asQWORD i, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << i;
	dest = stream.str();
	return dest;
}

static lite3dpp::String &AddAssignUInt64ToString(asQWORD i, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << i;
	dest += stream.str();
...
static lite3dpp::String AddStringUInt64(const lite3dpp::String &str, asQWORD i)
{
	lite3dpp::Stringstream stream;
	stream << i;
...
static lite3dpp::String AddInt64String(asINT64 i, const lite3dpp::String &str)
{
	lite3dpp::Stringstream stream;
	stream << i;
...
static lite3dpp::String &AssignInt64ToString(asINT64 i, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << i;
	dest = stream.str();
...
static lite3dpp::String &AddAssignInt64ToString(asINT64 i, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << i;
	dest += stream.str();
...
static lite3dpp::String AddStringInt64(const lite3dpp::String &str, asINT64 i)
{
	lite3dpp::Stringstream stream;
	stream << i;
	return str + stream.str();
...
static lite3dpp::String AddUInt64String(asQWORD i, const lite3dpp::String &str)
{
	lite3dpp::Stringstream stream;
	stream << i;
	return stream.str() + str;
...
static lite3dpp::String &AssignDoubleToString(double f, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << f;
	dest = stream.str();
...
static lite3dpp::String &AddAssignDoubleToString(double f, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << f;
	dest += stream.str();
...
static lite3dpp::String &AssignFloatToString(float f, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << f;
	dest = stream.str();
...
static lite3dpp::String &AddAssignFloatToString(float f, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << f;
	dest += stream.str();
...
static lite3dpp::String &AssignBoolToString(bool b, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << (b ? "true" : "false");
	dest = stream.str();
...
static lite3dpp::String &AddAssignBoolToString(bool b, lite3dpp::String &dest)
{
	lite3dpp::Stringstream stream;
	stream << (b ? "true" : "false");
	dest += stream.str();
...
static lite3dpp::String AddStringDouble(const lite3dpp::String &str, double f)
{
	lite3dpp::Stringstream stream;
	stream << f;
	return str + stream.str();
...
static lite3dpp::String AddDoubleString(double f, const lite3dpp::String &str)
{
	lite3dpp::Stringstream stream;
	stream << f;
	return stream.str() + str;
...
static lite3dpp::String AddStringFloat(const lite3dpp::String &str, float f)
{
	lite3dpp::Stringstream stream;
	stream << f;
	return str + stream.str();
...
static lite3dpp::String AddFloatString(float f, const lite3dpp::String &str)
{
	lite3dpp::Stringstream stream;
	stream << f;
	return stream.str() + str;
...
static lite3dpp::String AddStringBool(const lite3dpp::String &str, bool b)
{
	lite3dpp::Stringstream stream;
	stream << (b ? "true" : "false");
	return str + stream.str();
...
static lite3dpp::String AddBoolString(bool b, const lite3dpp::String &str)
{
	lite3dpp::Stringstream stream;
	stream << (b ? "true" : "false");
	return stream.str() + str;
...
static char *StringCharAt(unsigned int i, lite3dpp::String &str)
{
	if( i >= str.size() )
	{
...
static int StringCmp(const lite3dpp::String &a, const lite3dpp::String &b)
{
	int cmp = 0;
	if( a < b ) cmp = -1;
	else if( a > b ) cmp = 1;
...
// exists in the input lite3dpp::lited3dpp_string. If the substring doesn't exist in the input
// lite3dpp::lited3dpp_string -1 is returned.
//
// AngelScript signature:
// int lite3dpp::lited3dpp_string::findFirst(const lite3dpp::lited3dpp_string &in sub, uint start = 0) const
static int StringFindFirst(const lite3dpp::String &sub, asUINT start, const lite3dpp::String &str)
{
...
static int StringFindLast(const lite3dpp::String &sub, int start, const lite3dpp::String &str)
{
	// We don't register the method directly because the argument types change between 32bit and 64bit platforms
...
static asUINT StringLength(const lite3dpp::String &str)
{
...
static void StringResize(asUINT l, lite3dpp::String &str)
{
	// We don't register the method directly because the argument types change between 32bit and 64bit platforms
	str.resize(l);
}
...
static lite3dpp::String formatInt(asINT64 value, const lite3dpp::String &options, asUINT width)
{
	bool leftJustify = options.find("l") != lite3dpp::String::npos;
	bool padWithZero = options.find("0") != lite3dpp::String::npos;
	bool alwaysSign  = options.find("+") != lite3dpp::String::npos;
	bool spaceOnSign = options.find(" ") != lite3dpp::String::npos;
	bool hexSmall    = options.find("h") != lite3dpp::String::npos;
	bool hexLarge    = options.find("H") != lite3dpp::String::npos;
...
static lite3dpp::String formatFloat(double value, const lite3dpp::String &options, asUINT width, asUINT precision)
{
	bool leftJustify = options.find("l") != lite3dpp::String::npos;
	bool padWithZero = options.find("0") != lite3dpp::String::npos;
	bool alwaysSign  = options.find("+") != lite3dpp::String::npos;
	bool spaceOnSign = options.find(" ") != lite3dpp::String::npos;
	bool expSmall    = options.find("e") != lite3dpp::String::npos;
	bool expLarge    = options.find("E") != lite3dpp::String::npos;
...
static asINT64 parseInt(const lite3dpp::String &val, asUINT base, asUINT *byteCount)
{
...
double parseFloat(const lite3dpp::String &val, asUINT *byteCount)
{
	char *end;
...
static lite3dpp::String StringSubString(asUINT start, int count, const lite3dpp::String &str)
{
...
static bool StringEquals(const lite3dpp::String& lhs, const lite3dpp::String& rhs)
{
    return lhs == rhs;
}
...
void RegisterStdString_Native(asIScriptEngine *engine)
{
	...
	r = engine->RegisterObjectType("string", sizeof(lite3dpp::String), asOBJ_VALUE | asGetTypeTraits<lite3dpp::String>()); assert( r >= 0 );
#else
	r = engine->RegisterObjectType("string", sizeof(lite3dpp::String), asOBJ_VALUE | asOBJ_APP_CLASS_CDAK); assert( r >= 0 );
#endif
	...
	r = engine->RegisterObjectMethod("string", "string &opAssign(const string &in)", asMETHODPR(lite3dpp::String, operator =, (const lite3dpp::String&), lite3dpp::String&), asCALL_THISCALL); assert( r >= 0 );
...
//	r = engine->RegisterObjectMethod("string", "string &opAddAssign(const string &in)", asMETHODPR(string, operator+=, (const string&), string&), asCALL_THISCALL); assert( r >= 0 );
	...
	r = engine->RegisterObjectMethod("string", "bool opEquals(const string &in) const", asFUNCTIONPR(StringEquals, (const lite3dpp::String &, const lite3dpp::String &), bool), asCALL_CDECL_OBJFIRST); assert( r >= 0 );
	r = engine->RegisterObjectMethod("string", "int opCmp(const string &in) const", asFUNCTION(StringCmp), asCALL_CDECL_OBJFIRST); assert( r >= 0 );
	r = engine->RegisterObjectMethod("string", "string opAdd(const string &in) const", asFUNCTIONPR(operator +, (const lite3dpp::String &, const lite3dpp::String &), lite3dpp::String), asCALL_CDECL_OBJFIRST); assert( r >= 0 );
...
static void StringFactoryGeneric(asIScriptGeneric *gen)
{
  ...
  gen->SetReturnAddress(const_cast<lite3dpp::String*>(&StringFactory(length, s)));
}
#else
static void StringFactoryGeneric(asIScriptGeneric *gen)
{
  ...
  new (gen->GetAddressOfReturnLocation()) lite3dpp::String(StringFactory(length, s));
}
#endif

static void ConstructStringGeneric(asIScriptGeneric * gen)
{
  new (gen->GetObject()) lite3dpp::String();
}

static void CopyConstructStringGeneric(asIScriptGeneric * gen)
{
  lite3dpp::String * a = static_cast<lite3dpp::String *>(gen->GetArgObject(0));
  new (gen->GetObject()) lite3dpp::String(*a);
}

static void DestructStringGeneric(asIScriptGeneric * gen)
{
  using lite3dpp::String;
  lite3dpp::String * ptr = static_cast<lite3dpp::String *>(gen->GetObject());
  ptr->~String();
}
...
{
  lite3dpp::String * a = static_cast<lite3dpp::String *>(gen->GetArgObject(0));
  lite3dpp::String * self = static_cast<lite3dpp::String *>(gen->GetObject());
  *self = *a;
...
{
  lite3dpp::String * a = static_cast<lite3dpp::String *>(gen->GetObject());
  lite3dpp::String * b = static_cast<lite3dpp::String *>(gen->GetArgAddress(0));
...
{
  lite3dpp::String * self = reinterpret_cast<lite3dpp::String *>(gen->GetObject());
...
{
	lite3dpp::String *find = reinterpret_cast<lite3dpp::String*>(gen->GetArgAddress(0));
...
static void formatInt_Generic(asIScriptGeneric * gen)
{
	...
	lite3dpp::String *options = reinterpret_cast<lite3dpp::String*>(gen->GetArgAddress(1));
	asUINT width = gen->GetArgDWord(2);
	new(gen->GetAddressOfReturnLocation()) lite3dpp::String(formatInt(val, *options, width));
}
...
static void formatFloat_Generic(asIScriptGeneric *gen)
{
	...
	new(gen->GetAddressOfReturnLocation()) lite3dpp::String(formatFloat(val, *options, width, precision));
}

static void parseInt_Generic(asIScriptGeneric *gen)
{
	lite3dpp::String *str = reinterpret_cast<lite3dpp::String*>(gen->GetArgAddress(0));
...
static void AddString2DoubleGeneric(asIScriptGeneric * gen)
{
  ...
  lite3dpp::Stringstream sstr;
  sstr << *a << *b;
  lite3dpp::String ret_val = sstr.str();
  gen->SetReturnObject(&ret_val);
}
...
{
  double* a = static_cast<double *>(gen->GetAddressOfArg(0));
  lite3dpp::String * b = static_cast<lite3dpp::String *>(gen->GetObject());
  lite3dpp::Stringstream sstr;
  sstr << *a << *b;
  lite3dpp::String ret_val = sstr.str();
  gen->SetReturnObject(&ret_val);
...
static void StringSubString_Generic(asIScriptGeneric *gen)
{
    ...
    new(gen->GetAddressOfReturnLocation()) lite3dpp::String(StringSubString(start, count, *str));
}

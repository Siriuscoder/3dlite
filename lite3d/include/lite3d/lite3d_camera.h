...
LITE3D_CEXPORT void lite3d_camera_direction(const lite3d_camera *camera,
    kmVec3 *vec);
LITE3D_CEXPORT void lite3d_camera_world_direction(const lite3d_camera *camera,
    kmVec3 *vec);
LITE3D_CEXPORT void lite3d_camera_world_position(const lite3d_camera *camera,
    kmVec3 *pos);
LITE3D_CEXPORT void lite3d_camera_world_rotation(const lite3d_camera *camera,
    kmQuaternion *q);

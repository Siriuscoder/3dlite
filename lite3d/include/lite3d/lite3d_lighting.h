...
#define LITE3D_LIGHT_DISK_AREA                  (1u << 3)
#define LITE3D_LIGHT_RECT_AREA                  (1u << 4)
#define LITE3D_LIGHT_ENABLED                    (1u << 5)
#define LITE3D_LIGHT_SHADOW_STATIC              (1u << 6)
#define LITE3D_LIGHT_SHADOW_DYNAMIC             (1u << 7)
